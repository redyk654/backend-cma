<?php
    ...
    if(isset($_POST['date_min']) AND isset($_POST['date_max']) AND isset($_POST['assurance']) AND isset($_GET['categorie'])) {
        if ($_GET['categorie'] == 'pharmacie') {
            ...
            $req = $bdd->prepare("SELECT id_fac, id, code_patient, patient, prix_total, assurance, type_assurance, date_heure FROM
        ...
        // mise à jour du statu des factures réglés
        ...
        $req = $bdd->prepare("INSERT INTO facture_assurance(id_facture, nom, code_patient, assurance, assurance_type, periode, total, reste, date_heure) 
        VALUES(:id_facture, :nom, :code_patient, :assurance, :assurance_type, :periode, :total, :reste, NOW())");
