<?php
    ...
    if (isset($_POST['id']) AND isset($_POST['prix_total']) AND isset($_POST['a_payer']) AND isset($_POST['montant_verse']) AND isset($_POST['relicat']) AND isset($_POST['reste_a_payer']) AND isset($_POST['caissier'])) {
        ...
        $req = $bdd->prepare("INSERT INTO facture_pharmacie(id, caissier, prix_total, a_payer, montant_verse, relicat, reste_a_payer, date_heure) 
        VALUES(:id, :caissier, :prix_total, :a_payer, :montant_verse, :relicat, :reste_a_payer, NOW())");
